...
{
    internal class TecladoModel
    {
        private string tabla = "teclado";
        private Conexion conexion;
        public TecladoModel()
        {
            conexion = new Conexion();
        }
        public int Create(ETeclado entidad)
        {
            try
            {
        ...
        public List<ETeclado> ReadAll()
        {
            List<ETeclado> list = new List<ETeclado>();
        ...
        public int Update(ETeclado entidad)
        {
