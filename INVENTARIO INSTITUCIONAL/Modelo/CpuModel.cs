...
namespace INVENTARIO_INSTITUCIONAL.Modelo
{
    internal class CpuModel
    {
        ...
        public int Create(ECpu entidad)
        {
            try
            {
            ...
            {
                throw new Exception("Error al crear cpu: " + ex.Message);
            }
            finally
            {
                conexion.Close();
        ...
        public List<ECpu> ReadAll()
        {
            List<ECpu> list = new List<ECpu>();
        ...
        public int Update(ECpu entidad)
        {
